...
export class NavigationService {
    ...
    defaultMenu: IMenuItem[] = [
        ...
        {
            name: 'Parametres',
            description: 'Valeurs initiales',
            type: 'dropDown',
            icon: 'i-Gears',
            sub: [
                { icon: 'i-Split-Vertical', name: 'Societes', state: '/societe', type: 'link' },
                { icon: 'i-File-Edit', name: 'Nouvelle Societe', state: '/societes/nouvellesociete', type: 'link' },
                { icon: 'i-Business-Mens', name: 'Salaries', state: '/societe', type: 'link' },
                { icon: 'i-Add-User', name: 'Nouveau Salarie', state: '/societe', type: 'link' },
