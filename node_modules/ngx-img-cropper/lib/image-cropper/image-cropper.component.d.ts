...
export declare class ImageCropperComponent implements AfterViewInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ImageCropperComponent, "img-cropper", never, { "settings": "settings"; "cropper": "cropper"; "image": "image"; "inputImage": "inputImage"; "cropPosition": "cropPosition"; }, { "cropPositionChange": "cropPositionChange"; "onCrop": "onCrop"; "imageSet": "imageSet"; }, never, never>;
}
